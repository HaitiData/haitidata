 ...
 * Adds ``haitidata`` to installed applications, updates templates, staticfiles dirs, sets urlconf to ``haitidata.urls``.
...
|---|---|---|---|---|
|`geonode.settings`|included by ->|`haitidata.local_settings`|included by ->|`haitidata.settings`|
